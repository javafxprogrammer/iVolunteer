...
public class ActivityRefreshAdapter {
    ...
    String user_email;
    String volunteer_firstName;
    String volunteer_sirName;
    ...
    public void refresh(){
        ...
        while (all_activitys.moveToNext()) {
            ...
            this.volunteer_firstName = all_activitys.getString(6);
            this.volunteer_sirName = all_activitys.getString(7);
            this.volunteer_names = "Volunteer: " + volunteer_firstName.concat(" " + volunteer_sirName);
            ...
            activity_list.add(new ActivtyModel(
                    ...
                    this.volunteer_names, this.activity_description));
        }
