...
public class ActivityEdit extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.volunteerFNameParent = (TextInputLayout) findViewById(R.id.edit_activity_volunteer_firstName_parent);
        this.volunteerLNameParent = (TextInputLayout) findViewById(R.id.edit_activity_volunteer_sirName_parent_id);
        ...
        this.volunteer_firstName = (TextInputEditText) findViewById(R.id.edit_activity_volunteer_firstName);
        this.volunteer_sirName = (TextInputEditText) findViewById(R.id.edit_activity_volunteer_sirName_id);
    ...
    public void edit_submit_btn_clicked(View view) {
        ...
        if (!activity_name.isEmpty() && !volunteer_firstName.isEmpty() && !volunteer_sirName.isEmpty()) {
                boolean editedActivity = sqlConnect.edit_activity(this.activity_image, activity_name, activity_location, this.activity_date, activity_time, user_email, volunteer_firstName, volunteer_sirName, this.old_title, activity_desc);
                if (editedActivity) {
