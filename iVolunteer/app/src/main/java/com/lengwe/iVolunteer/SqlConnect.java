...
public class SqlConnect extends SQLiteOpenHelper {
    ...
    public static final String VOLUNTEER_FIRSTNAME = "volunteer_firstName";
    public static final String VOLUNTEER_SIRNAME = "volunteer_sirName";
    ...
    public static final String CREATE_ACTIVITY_TABLE = "CREATE TABLE " + ACTIVITY_TABLE + "(\n" +
            ...
            "" + VOLUNTEER_FIRSTNAME + " VARCHAR(32) NOT NULL,\n" +
            "" + VOLUNTEER_SIRNAME + " VARCHAR(32) NOT NULL,\n" +
    ...
    public boolean add_activity(String activity_image, String activity_name, String activity_location,
                             ...
                             String user_email, String volunteer_fName, String volunteer_sName, String activity_description) {
        ...
        contentValues.put(VOLUNTEER_FIRSTNAME, volunteer_fName);
        contentValues.put(VOLUNTEER_SIRNAME, volunteer_sName);
    ...
    public boolean edit_activity(String activity_image, String activity_name, String activity_location,
                              String activity_date, String activity_time,
                              String user_email, String volunteer_fName, String volunteer_sName,
